...
function ManagerProfile() {
    ...
    useEffect(() => {
        ...
        axios
            .get("localhost:8081/api/v1/manager/profile")
                ...
                <div className="col-md-7">
                    <div className="card p-3 py-4">
                        ...
                        <div className="text-center">
                            <img src="/src/frontend/react-hiringsystem/src/pages/css/images/manager.jpg"
                                 alt="Manager" width="300" className="rounded-circle"/>
                        </div>
