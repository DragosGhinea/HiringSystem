...
function CandidateProfile() {
    ...
    useEffect(() => {
        ...
        axios
            .get("localhost:8081/api/v1/candidate/profile")
                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="d-flex flex-column align-items-center text-center">
                                    <img src="/css/images/candidate.png" alt="Candidate" width="150"/>
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-9 text-secondary personalDataPanel">
                                                            <div className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                                                ...
                                                                <span className="text-secondary"><a href="{user.githubProfileLink}"></a></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                        <div className="row">
                                                            ...
                                                            <div className="col-sm-9 text-secondary personalDataPanel">
                                                                ...
                                                                <span className="text-secondary"><a href="{user.linkedInProfileLink}"></a></span>
                                                            </div>
                                                            </div>
                                                        </div>
                                                    </hr>
                                ...
                                <div className="card-body align-items-center justify-content-between">
                                    ...
                                    <ul className="text-secondary">
                                        {user.cv.academicBackground.map(academicBackground => (
                                            <li key={academicBackground}>{academicBackground.startDate + '-' + academicBackground.endDate + '\n' + academicBackground.institution + ', ' + academicBackground.specialization}</li>
                                        ))}
                                    </ul>
                                </div>
                                ...
                                <div className="card-body align-items-center justify-content-between">
                                    ...
                                    <ul className="text-secondary">
                                        {user.cv.workExperience.map(workExperience => (
                                            <li key={workExperience}>{workExperience.startDate} + '-' + {workExperience.endDate} + '\n' + {workExperience.company} + ', ' + {workExperience.position}</li>
                                        ))}
                                    </ul>
                                </div>
                                <div className="card-footer">
